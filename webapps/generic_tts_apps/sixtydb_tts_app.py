...
CONFIG_PATH = AGENT_CONFIG_PATH or "packages/sinapsis_60db/src/sinapsis_60db/configs/sixtydb_tts_demo.yaml"
GENERIC_KEY = "SixtyDBTTS"


class SixtyDBTTSApp(TTSAppAudioFromGeneric):
...
if __name__ == "__main__":
    """Launches the 60dB TTS application via Gradio."""
    sinapsis_tts = SixtyDBTTSApp(CONFIG_PATH, GENERIC_KEY, "60dB")
