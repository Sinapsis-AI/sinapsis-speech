...
CONFIG_PATH = AGENT_CONFIG_PATH or "packages/sinapsis_csm/src/sinapsis_csm/configs/csm_app.yaml"
BASE_AUDIO_PATH = f"{SINAPSIS_CACHE_DIR}/webapp/audios"


if __name__ == "__main__":
    """
    Entry point for launching the CSM application.
    ...
    """
    sinapsis_tts = TTSAppAudioFromPacket(CONFIG_PATH, BASE_AUDIO_PATH, "CSM")
