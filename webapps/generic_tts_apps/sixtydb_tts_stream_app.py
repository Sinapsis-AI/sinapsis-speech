...
CONFIG_PATH = (
    AGENT_CONFIG_PATH or "packages/sinapsis_60db/src/sinapsis_60db/configs/sixtydb_tts_stream_demo.yaml"
)
GENERIC_KEY = "SixtyDBTTSStream"


class SixtyDBTTSStreamApp(TTSAppAudioFromGeneric):
...
if __name__ == "__main__":
    """Launches the 60dB streaming TTS application via Gradio."""
    sinapsis_tts = SixtyDBTTSStreamApp(CONFIG_PATH, GENERIC_KEY, "60dB")
